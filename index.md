...
<style>
  ...
  @font-face {
    font-family: 'Loubag';
    src: url('assets/loubag.ttf') format('truetype'); /* Standard Loubag */
  }

  @font-face {
    font-family: 'Loubag-Semi-Bold';
  ...
  body { 
    margin: 0; padding: 0;
    font-family: 'Loubag', sans-serif; /* Body Text: Loubag */
  ...
  /* Semi-transparent animated logo */
  .animated-logo { 
    width: 10rem; 
    margin-bottom: 3rem; 
    opacity: 0.75; /* Coding transparency */
  }
  ...
  /* Loubag-Semi-Bold for Subtitle */
  .hero-subtitle {
    font-family: 'Loubag-Semi-Bold', sans-serif;
  ...
  /* Updated Award Section to fill space */
  .achievement-panel {
    background: white; padding: 4rem; border-radius: 2rem;
    display: flex; align-items: center; justify-content: space-between; /* Space between content */
    flex-wrap: wrap; margin-bottom: 5rem; border: 0.5rem solid var(--rfc-red);
    gap: 3rem;
  }

  .achievement-text-box {
    flex: 1; /* Makes text fill available space */
    min-width: 300px;
  }

  .bar-logo { height: 11rem; width: auto; flex-shrink: 0; }
  ...
  @media (max-width: 768px) {
    ...
    .bar-logo { height: 8rem; margin: 0 auto; }
    .achievement-panel { padding: 2.5rem; text-align: center; justify-content: center; }
  }
...
<div class="main-wrapper">
  <div class="achievement-panel">
    <div class="achievement-text-box">
      <h2 style="font-family: 'Notable', sans-serif; color: var(--rfc-blue); font-size: 3rem; margin: 0; line-height: 1.1;">ADVANCING AVIATION AT RPI</h2>
      <p style="font-size: 1.3rem; margin-top: 1.5rem; color: var(--rfc-blue); font-family: 'Loubag', sans-serif; opacity: 0.9;">
  ...
  <div style="text-align: center; margin: 5rem 0;">
    <p style="color: #444; font-size: 1.4rem; max-width: 55rem; margin: 0 auto; line-height: 1.6; font-family: 'Loubag', sans-serif;">
      Whether you're training for your private pilot license or simply love the view from above, we provide the community and resources to help you take flight.
    </p>
  </div>
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(18rem, 1fr)); gap: 1.5rem;">
    ...
    <img src="assets/event2.jpg" style="width:100%; height:25rem; object-fit:cover; border-radius:25px;" alt="Event 2">
    <img src="assets/event3.jpg" style="width:100%; height:25rem; object-fit:cover; border-radius:25px;" alt="Event 3">
  </div>
...
<script>
  window.onscroll = function() {
    ...
    if (document.documentElement.scrollTop > 60) { bg.classList.add("blurred-more"); } 
    else { bg.classList.remove("blurred-more"); }
  };
