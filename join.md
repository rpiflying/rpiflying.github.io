...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* DUES & BENEFITS GRID */
  .benefits-grid { display: grid; grid-template-columns: 1fr 1.5fr; gap: 2rem; margin-bottom: 3rem; }
  
  .dues-card {
    background: var(--rfc-blue); color: white; border-radius: 2rem; padding: 2.5rem;
    display: flex; flex-direction: column; justify-content: center; text-align: center;
  }
  .dues-price { font-size: 3rem; font-family: 'Notable', sans-serif; color: var(--rfc-gold); margin: 0.5rem 0; }
  ...
  .benefits-card h2 { font-family: 'Notable', sans-serif; color: var(--rfc-blue); margin-top: 0; font-size: 1.5rem; }
  
  /* GROUND SCHOOL SPECIAL SECTION */
  .ground-school-promo {
    background: linear-gradient(135deg, #fff 0%, #fff3dc 100%);
    border: 4px dashed var(--rfc-red); border-radius: 2rem;
    padding: 2.5rem; margin-bottom: 3rem; position: relative;
  }
  .promo-tag {
    position: absolute; top: -15px; right: 20px; background: var(--rfc-red);
    color: white; padding: 5px 15px; border-radius: 20px; font-weight: bold; font-size: 0.8rem;
  }
  ...
  .external-button {
    ...
    letter-spacing: 1px; transition: 0.3s; border: 2px solid var(--rfc-blue);
  }
...
<div class="main-wrapper">
  ...
  <div class="ground-school-promo">
    <div class="promo-tag">NEW FOR 2027</div>
    <h2 style="font-family: 'Notable', sans-serif; color: var(--rfc-red); margin-top: 0;">Ground School Discounts</h2>
    <p style="font-size: 1.1rem; line-height: 1.6; color: var(--rfc-blue);">
      Our <strong>Ground School</strong> program (hosted in partnership with <strong>Hewison Aviation</strong>) is open to the entire RPI community. However, RFC members receive significant substituted costs:
    </p>
    <ul class="step-list">
  ...
  <div class="onboarding-box">
    <h2 style="font-family: 'Notable', sans-serif; color: var(--rfc-blue); margin-top: 0;">How to Join</h2>
    <ul class="step-list">
